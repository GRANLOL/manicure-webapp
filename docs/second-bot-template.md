...
Редактировать его вручную **не нужно** — все настройки заполняются после запуска через **админ-панель** бота:

- Название, адрес, ссылка на карту — `⚙️ Кнопки меню`
- Часовой пояс — в разделе настроек
- Рабочие часы и расписание — в разделе расписания
- Логотип и шапка WebApp — `🖼 Шапка WebApp`
